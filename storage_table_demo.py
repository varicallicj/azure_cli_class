...
resourcegroup_name = 'cjv'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
storageaccount_name = 'cjv'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
location = 'eastus'
...
car.RowKey = '001'
car.description = 'Dodge Dart'
car.cost = 20
table_service.insert_entity('itemstable', car)
print('Created entry for Dodge Dart...')

car = Entity()
car.PartitionKey = 'cardealer'
car.RowKey = '002'
car.description = 'Dodge Charger'
car.cost = 30
table_service.insert_entity('itemstable', car)
...
car.PartitionKey = 'cardealer'
car.RowKey = '003'
car.description = 'Dodge Challenger'
car.cost = 40
table_service.insert_entity('itemstable', car)
print('Created entry for Dodge Challenger...\n')
...
coffee.RowKey = '005'
coffee.sku = 'brown'
coffee.item = 'brown coffee'
coffee.cost = 1.50
table_service.insert_entity('itemstable', coffee)
print('Created entry for a brown coffee...\n')
time.sleep(1)
